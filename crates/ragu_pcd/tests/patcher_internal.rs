...
fn expected(name: &str, point: &str) -> Census {
    ...
    let (pinned, rejected) = match (name, point) {
        ...
        ("bind_endoscalar", "leaves") => (50, 268),
        ("bind_endoscalar", "nodes") => (45, 273),
        (step, "seeded") if step.starts_with("native_endoscaling_step_") => (49, 135),
        (step, "leaves") if step.starts_with("native_endoscaling_step_") => (49, 135),
        (step, "nodes") if step.starts_with("native_endoscaling_step_") => (44, 140),
        ("nested_export", "seeded") => (115, 650),
        ("nested_export", "leaves") => (119, 646),
        ("nested_export", "nodes") => (114, 651),
        ("nested_collapse", "seeded") => (116, 661),
        ("nested_collapse", "leaves") => (119, 656),
        ("nested_collapse", "nodes") => (114, 661),
        ("nested_compute_v", "seeded") => (114, 651),
        ("nested_compute_v", "leaves") => (118, 647),
        ("nested_compute_v", "nodes") => (113, 652),
        (_, "seeded") => (49, 145),
        (_, "leaves") => (49, 145),
        (_, "nodes") => (44, 150),
