...
pub fn eval<F: Field, C: Circuit<F>, R: Rank>(
...

    {
...

        {
            ...
            // Allocate the ONE gate (gate 0). The registry key constraint that
            // binds the a-wire of this gate to the registry digest is injected
            // at the registry level, not here.
