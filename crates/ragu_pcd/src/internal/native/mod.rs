...
//! `pre_beta`. This mirrors the nested side's walk over the native batch.
//!
//! Full recursive verification also requires the shared bit and curve
//! contracts, commitments fixed before the relevant transcript challenges, and
//! bindings connecting the walk's inputs and endpoint to the intended
