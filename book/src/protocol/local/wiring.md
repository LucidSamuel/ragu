...
committed; see [Registry Tags](../../guide/configuration.md#registry-tags). Its
purpose is to make non-trivial evaluations of $s$ unpredictable even to someone
who chooses the circuits.
